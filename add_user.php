...
$birth_day = null;
$birth_date = null;
// Eestikeelsed kuude nimed massiivis
...
if (isset($_POST["user_data_submit"])) {
    ...
    // Kuupäeva valiidsus ehk reaaslsuse kontroll
...
<html lang = "et">
    ...
    <body>
        ...
        <label>Eesnimi</label>
        <br>
        <input name="first_name_input" type="text" value="<?php echo $name; ?>"><span><?php echo $name_error; ?></span>
        <br>
        <label>Perekonnanimi</label><br>
        <input name="surname_input" type="text" value="<?php echo $surname; ?>"><span><?php echo $surname_error; ?></span>
        <br>

        <input type="radio" name="gender_input" value="2" <?php if($gender == "2") {echo "checked";} ?>><label for="">Naine</label>
        <input type="radio" name="gender_input" value="2" <?php if($gender == "1") {echo "checked";} ?>><label for="">Mees</label>
        <br>
        ...
        <br>
        <input type="password" name="password_input"><span><?php echo $password_error; ?></span>
        <br>
